...
wget -c https://github.com/runatlantis/atlantis/releases/download/v0.21.0/atlantis_linux_386.zip 
unzip ${ATLANTIS_PACKAGE}

echo "Downloading ngrok: To have access to the internet"
wget -c https://bin.equinox.io/c/4VmDzA7iaHb/ngrok-stable-darwin-amd64.zip -o - \ | tar -xz
